...
Generated: 2026-04-24T06:39:11Z
...
- Major failure modes: unrun cells, short smoke duration, and missing medium/full runs.
- Recommended next step: run `ablation` mode with at least two seeds on the server, then run CIFAR medium for the top two image paths.
...
| run_id | model | dataset | final metric | best metric | loss | accuracy | time sec | params |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| probe_gate_compat_sigmoid_update | probe_gate_compat_sigmoid_update | synthetic_probe_tensors | 1.0 | 1.0 | 0.0000 |  | 0.0009777545928955078 | 14151 |
| probe_responsibility_no_null_precision | probe_responsibility_no_null_precision | synthetic_probe_tensors | 1.0 | 1.0 | 0.0000 |  | 0.000885009765625 | 14151 |
| probe_responsibility_with_null_precision | probe_responsibility_with_null_precision | synthetic_probe_tensors | 1.0 | 1.0 | 0.0000 |  | 0.0009799003601074219 | 14151 |
