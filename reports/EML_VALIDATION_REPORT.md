...
Generated: 2026-04-24T07:22:44Z
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| ablation_gate_sigmoid_seed0 | COMPLETED | ablation_gate_sigmoid_seed0 | 1.0 | 1.0 | 0.0000 | 0.0000 | 0.25910401344299316 |  |
| ablation_resp_no_null_seed0 | COMPLETED | ablation_resp_no_null_seed0 | 1.0 | 1.0 | 0.0000 | 0.0000 | 0.018465518951416016 |  |
| ablation_resp_null_seed0 | COMPLETED | ablation_resp_null_seed0 | 1.0 | 1.0 | 0.0000 | 0.0000 | 0.003811359405517578 |  |
| ablation_gate_sigmoid_seed1 | COMPLETED | ablation_gate_sigmoid_seed1 | 1.0 | 1.0 | 0.0000 | 0.0000 | 0.0025916099548339844 |  |
| ablation_resp_no_null_seed1 | COMPLETED | ablation_resp_no_null_seed1 | 1.0 | 1.0 | 0.0000 | 0.0000 | 0.0037970542907714844 |  |
| ablation_resp_null_seed1 | COMPLETED | ablation_resp_null_seed1 | 1.0 | 1.0 | 0.0000 | 0.0000 | 0.0031576156616210938 |  |
| ablation_gate_sigmoid_seed2 | COMPLETED | ablation_gate_sigmoid_seed2 | 1.0 | 1.0 | 0.0000 | 0.0000 | 0.0028243064880371094 |  |
| ablation_resp_no_null_seed2 | COMPLETED | ablation_resp_no_null_seed2 | 1.0 | 1.0 | 0.0000 | 0.0000 | 0.0034532546997070312 |  |
| ablation_resp_null_seed2 | COMPLETED | ablation_resp_null_seed2 | 1.0 | 1.0 | 0.0000 | 0.0000 | 0.0038552284240722656 |  |
| ablation_sigmoid_gate_mean | NOT RUN | sigmoid_gate_mean |  |  |  |  |  | graph mode is not implemented |
| ablation_thresholded_null | NOT RUN | responsibility_thresholded_null |  |  |  |  |  | threshold mode is not implemented |
...
| run_id | status | model | best | final | delta vs ref | loss | time sec | notes |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| ablation_image_cnn_eml | FAILED | cnn_eml |  |  |  |  |  | RuntimeError("Too many open files. Communication with the workers is no longer possible. Please increase the limit using `ulimit -n` in the shell or change the sharing strategy by calling `torch.multiprocessing.set_sharing_strategy('file_system')` at the beginning of your code") |
| ablation_image_pure_eml | FAILED | pure_eml |  |  |  |  |  | RuntimeError("Too many open files. Communication with the workers is no longer possible. Please increase the limit using `ulimit -n` in the shell or change the sharing strategy by calling `torch.multiprocessing.set_sharing_strategy('file_system')` at the beginning of your code") |
| ablation_image_pure_eml_v2 | COMPLETED | pure_eml_v2 | 0.328125 | 0.109375 | -0.6719 | 1.6359 | 1.7702131271362305 | early_stop=True |
| ablation_image_eff_attr4 | COMPLETED | EfficientEMLImageClassifier_attr4 | 0.34375 | 0.15625 | -0.6562 | 1.6222 | 1.520871639251709 | early_stop=True |
| ablation_image_eff_attr8 | COMPLETED | EfficientEMLImageClassifier_attr8 | 0.40625 | 0.25 | -0.5938 | 1.5897 | 2.6269795894622803 | early_stop=True |
| ablation_image_eff_window5 | COMPLETED | EfficientEMLImageClassifier_window5 | 0.375 | 0.109375 | -0.6250 | 1.6142 | 1.149688482284546 | early_stop=True |
| ablation_image_eff_no_warmup | COMPLETED | EfficientEMLImageClassifier_no_warmup | 0.296875 | 0.265625 | -0.7031 | 1.6085 | 1.674051284790039 | early_stop=True |
| ablation_no_composition | NOT RUN | EfficientEMLImageClassifier_no_composition |  |  |  |  |  | model switch is not standardized |
| ablation_no_attractor | NOT RUN | EfficientEMLImageClassifier_no_attractor |  |  |  |  |  | model switch is not standardized |
| ablation_head_without_ambiguity | NOT RUN | prototype_head_without_ambiguity |  |  |  |  |  | head switch is not standardized |
| ablation_image_cnn_eml_workers0 | COMPLETED | cnn_eml_workers0 | 1.0 | 0.953125 | 0.0000 | 0.3554 | 16.250306606292725 | early_stop=False |
| ablation_image_pure_eml_workers0 | COMPLETED | pure_eml_workers0 | 0.5 | 0.328125 | -0.5000 | 1.4465 | 5.7693750858306885 | early_stop=True |

### Text Local Window
| run_id | status | model | best | final | delta vs ref | loss | time sec | notes |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| ablation_text_eff_window8 | FAILED | EfficientEMLTextEncoder_window8 |  |  |  |  |  | RuntimeError("Too many open files. Communication with the workers is no longer possible. Please increase the limit using `ulimit -n` in the shell or change the sharing strategy by calling `torch.multiprocessing.set_sharing_strategy('file_system')` at the beginning of your code") |
| ablation_text_eff_window16 | FAILED | EfficientEMLTextEncoder_window16 |  |  |  |  |  | RuntimeError("Too many open files. Communication with the workers is no longer possible. Please increase the limit using `ulimit -n` in the shell or change the sharing strategy by calling `torch.multiprocessing.set_sharing_strategy('file_system')` at the beginning of your code") |
| ablation_text_eff_window32 | FAILED | EfficientEMLTextEncoder_window32 |  |  |  |  |  | RuntimeError("Too many open files. Communication with the workers is no longer possible. Please increase the limit using `ulimit -n` in the shell or change the sharing strategy by calling `torch.multiprocessing.set_sharing_strategy('file_system')` at the beginning of your code") |
| ablation_text_eff_window8_workers0 | COMPLETED | EfficientEMLTextEncoder_window8_workers0 | 0.4983498454093933 | 0.44842565059661865 | 0.0000 | 2.1090 | 25.918776035308838 | early_stop=False |
| ablation_text_eff_window16_workers0 | COMPLETED | EfficientEMLTextEncoder_window16_workers0 | 0.428720623254776 | 0.4079952836036682 | -0.0696 | 2.0972 | 25.262678384780884 | early_stop=False |
| ablation_text_eff_window32_workers0 | COMPLETED | EfficientEMLTextEncoder_window32_workers0 | 0.47152942419052124 | 0.449638307094574 | -0.0268 | 2.1149 | 26.068734169006348 | early_stop=False |

### CIFAR Medium
| run_id | status | model | best | final | delta vs ref | loss | time sec | notes |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| cifar_cnn_eml | COMPLETED | cnn_eml | 0.6966796875 | 0.6966796875 | 0.0000 | 0.8466 | 53.06012463569641 | early_stop=False |
| cifar_pure_eml | COMPLETED | pure_eml | 0.3857421875 | 0.3857421875 | -0.3109 | 1.6892 | 48.45666170120239 | early_stop=False |
| cifar_pure_eml_v2 | COMPLETED | pure_eml_v2 | 0.3833984375 | 0.3431640625 | -0.3133 | 1.6665 | 102.29234170913696 | early_stop=False |
| cifar_efficient_eml_image | COMPLETED | EfficientEMLImageClassifier | 0.2537109375 | 0.2310546875 | -0.4430 | 1.9718 | 25.30465316772461 | early_stop=True |
