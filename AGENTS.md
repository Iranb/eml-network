...
This project is indexed by GitNexus as **eml-network** (13701 symbols, 16389 relationships, 153 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/eml-network/context` | Codebase overview, check index freshness |
| `gitnexus://repo/eml-network/clusters` | All functional areas |
| `gitnexus://repo/eml-network/processes` | All execution flows |
| `gitnexus://repo/eml-network/process/{name}` | Step-by-step execution trace |
